...
#
#     PHX_SERVER=true bin/cheerful_donor start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :cheerful_donor, CheerfulDonorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  eventstore_database_url =
    System.get_env("EVENTSTORE_DATABASE_URL") ||
      ...
      For example: ecto://USER:PASS@HOST/cheerful_donor_eventstore
      """
  ...
  config :cheerful_donor, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :cheerful_donor, CheerfulDonor.Mailer,
