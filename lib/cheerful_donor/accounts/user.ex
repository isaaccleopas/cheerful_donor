defmodule CheerfulDonor.Accounts.User do
  use Ash.Resource,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender CheerfulDonor.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource CheerfulDonor.Accounts.Token
      signing_secret CheerfulDonor.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender CheerfulDonor.Accounts.User.Senders.SendPasswordResetEmail
